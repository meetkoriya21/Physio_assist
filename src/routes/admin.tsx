...
const INITIAL_BLOGS: Blog[] = [
  { id: 1, title: "5 desk-job stretches to fix your posture", category: "Posture", date: "May 8, 2026", readTime: "4", excerpt: "Sitting all day quietly reshapes your spine. These five stretches take five minutes and reverse it.", status: "published" },
  { id: 2, title: "Why your knee pain isn't really your knee", category: "Pain", date: "April 22, 2026", readTime: "6", excerpt: "Most knee pain originates higher up the chain. Here's how we trace it — and treat it — at the source.", status: "published" },
  { id: 3, title: "Returning to running after injury", category: "Sports", date: "April 3, 2026", readTime: "7", excerpt: "A safe four-week protocol to rebuild mileage without re-injury, used with our sports patients.", status: "published" },
];

const INITIAL_APPOINTMENTS: Appointment[] = [
  { id: 1, name: "Anna Müller", email: "anna.muller@email.com", phone: "+43 664 123 4567", service: "Back & Neck Pain", date: "May 20, 2026", time: "10:00 AM", message: "I have been experiencing lower back pain for 3 weeks.", status: "pending", submittedAt: "May 16, 2026 · 9:14 AM" },
  { id: 2, name: "Lukas Richter", email: "lukas.r@mail.at", phone: "+43 699 987 6543", service: "Sports Injury", date: "May 21, 2026", time: "2:00 PM", message: "Knee injury from football match last weekend.", status: "pending", submittedAt: "May 16, 2026 · 10:02 AM" },
  { id: 3, name: "Sofia Danova", email: "sofia.d@gmail.com", phone: "+43 676 555 4321", service: "Post-Surgery Rehab", date: "May 19, 2026", time: "11:30 AM", message: "Post knee surgery, need guided rehabilitation.", status: "accepted", submittedAt: "May 15, 2026 · 4:45 PM" },
  { id: 4, name: "Marco Bianchi", email: "marco.b@email.it", phone: "+39 333 765 4321", service: "Manual Therapy", date: "May 18, 2026", time: "9:00 AM", message: "", status: "rejected", submittedAt: "May 14, 2026 · 2:30 PM" },
  { id: 5, name: "Elena Kovač", email: "elena.kovac@mail.hr", phone: "+385 91 234 5678", service: "Neurological Rehab", date: "May 22, 2026", time: "3:30 PM", message: "Referred by Dr. Weber for neuro rehab after stroke.", status: "pending", submittedAt: "May 16, 2026 · 11:55 AM" },
  { id: 6, name: "James O'Brien", email: "james.ob@mail.ie", phone: "+353 87 654 3210", service: "Home Visit", date: "May 23, 2026", time: "10:30 AM", message: "Elderly parent, cannot travel, requesting home visit.", status: "pending", submittedAt: "May 16, 2026 · 1:20 PM" },
];
...
function ConfirmModal({ title, body, onConfirm, onCancel, danger = true }: { title: string; body: string; onConfirm: () => void; onCancel: () => void; danger?: boolean }) {
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.4)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 250 }}>
      <div style={{ background: "#fff", borderRadius: 16, padding: 32, width: 380, textAlign: "center", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}>
        ...
        <div style={{ display: "flex", gap: 12, justifyContent: "center" }}>
          ...
          <button onClick={onConfirm} style={{ padding: "10px 24px", borderRadius: 10, background: danger ? "#DC2626" : "#1D9E75", color: "#fff", fontWeight: 700, border: "none", cursor: "pointer" }}>Confirm</button>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #f0faf5 0%, #e6f4ed 100%)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Segoe UI', sans-serif" }}>
      <div style={{ background: "#fff", borderRadius: 20, boxShadow: "0 8px 40px rgba(15,110,86,0.12)", padding: "48px 40px", width: 420, maxWidth: "90vw" }}>
        ...
        <p style={{ fontSize: 12, color: "#9CA3AF", textAlign: "center", marginTop: 20 }}>Not linked anywhere on the website.<br />Access directly via <strong>/admin</strong></p>
      </div>
    </div>
  );
}
...
// ─── Blog Form Modal ──────────────────────────────────────────────────────────
function BlogForm({ blog, onSave, onCancel }: { blog?: Blog; onSave: (b: Omit<Blog, "id">) => void; onCancel: () => void }) {
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.45)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 200, padding: 20 }}>
      <div style={{ background: "#fff", borderRadius: 20, padding: "36px 32px", width: 560, maxWidth: "100%", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input value={title} onChange={e => setTitle(e.target.value)} placeholder="Blog post title…" style={inp} />
        </div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <input value={date} onChange={e => setDate(e.target.value)} placeholder="May 16, 2026" style={inp} />
        </div>
        <div style={{ marginBottom: 16 }}>
          <label style={lbl}>Excerpt *</label>
          <textarea value={excerpt} onChange={e => setExcerpt(e.target.value)} rows={3} placeholder="Short description shown on blog listing page…" style={{ ...inp, resize: "vertical" }} />
        </div>
        <div style={{ marginBottom: 24 }}>
    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.45)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 200, padding: 20 }}>
      <div style={{ background: "#fff", borderRadius: 20, padding: "36px 32px", width: 520, maxWidth: "100%", boxShadow: "0 20px 60px rgba(0,0,0,0.2)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 24 }}>
          <div>
            <h3 style={{ fontSize: 20, fontWeight: 700, color: "#0F2E24", marginBottom: 6 }}>Appointment Details</h3>
...
function AppointmentsTab({ showToast }: { showToast: (m: string) => void }) {
  ...
  const removeAppt = (id: number) => { setAppointments(prev => prev.filter(a => a.id !== id)); setSelected(null); setDeleteId(null); showToast("Appointment removed."); };
  ...
  return (
    <div>
      ...
      <div style={{ background: "#fff", borderRadius: 16, boxShadow: "0 2px 12px rgba(15,110,86,0.06)", overflow: "hidden" }}>
        {filtered.length === 0 ? (
          <div style={{ padding: "60px 24px", textAlign: "center", color: "#9CA3AF", fontSize: 15 }}>No appointments found.</div>
        ) : (
                ...
                >
                  ...
                  <td style={{ padding: "14px 18px" }}>
                    <div style={{ display: "flex", gap: 6, flexWrap: "wrap" }}>
                      ...
                      {a.status === "pending" && <>
                        <button onClick={() => updateStatus(a.id, "accepted")} style={{ padding: "6px 12px", borderRadius: 7, border: "none", background: "#1D9E75", color: "#fff", fontSize: 12, fontWeight: 700, cursor: "pointer" }}>✓ Accept</button>
                        <button onClick={() => updateStatus(a.id, "rejected")} style={{ padding: "6px 12px", borderRadius: 7, border: "none", background: "#FEE2E2", color: "#B91C1C", fontSize: 12, fontWeight: 700, cursor: "pointer" }}>✕ Reject</button>
                      </>}
...
function BlogTab({ showToast }: { showToast: (m: string) => void }) {
  ...
  const handleAdd = (data: Omit<Blog, "id">) => { setBlogs(prev => [{ ...data, id: Date.now() }, ...prev]); setShowForm(false); showToast("✓ Blog post created!"); };
  const handleEdit = (data: Omit<Blog, "id">) => { setBlogs(prev => prev.map(b => b.id === editBlog?.id ? { ...data, id: b.id } : b)); setEditBlog(undefined); showToast("✓ Blog post updated!"); };
  const handleDelete = (id: number) => { setBlogs(prev => prev.filter(b => b.id !== id)); setDeleteId(null); showToast("Blog post deleted."); };
    ...
    <div style={{ minHeight: "100vh", background: "#F4FAF7", fontFamily: "'Segoe UI', sans-serif" }}>
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #E6F4ED", padding: "0 32px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <a href="https://physio-wellness-portal-main.vercel.app" target="_blank" rel="noreferrer" style={{ fontSize: 13, color: "#1D9E75", textDecoration: "none", fontWeight: 600 }}>↗ View Website</a>
      ...
      <div style={{ background: "#fff", borderBottom: "1px solid #E6F4ED", padding: "0 32px", display: "flex", gap: 4 }}>
        {([{ key: "appointments", label: "📅  Appointments", desc: "Review patient booking requests" }, { key: "blogs", label: "✍️  Blog Posts", desc: "Manage clinic content" }] as const).map(t => (
          <button key={t.key} onClick={() => setActiveTab(t.key)} style={{ padding: "16px 20px", background: "none", border: "none", borderBottom: `3px solid ${activeTab === t.key ? "#1D9E75" : "transparent"}`, color: activeTab === t.key ? "#0F6E56" : "#6B7280", fontWeight: activeTab === t.key ? 700 : 500, fontSize: 14, cursor: "pointer", transition: "all 0.15s" }}>
            {t.label}
          </button>
        ))}
      </div>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "32px 24px" }}>
        <div style={{ marginBottom: 24 }}>
          ...
          <p style={{ fontSize: 14, color: "#6B9E8A" }}>
            {activeTab === "appointments" ? "View, accept or reject patient booking requests from your website." : "Create, edit and publish blog posts to your clinic website."}
          </p>
        </div>
...
// ─── Entry Point — add <Route path="/admin" element={<AdminPanel />} /> ───────
import { useState } from "react";
