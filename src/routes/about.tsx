...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Dr. [Sister Name] — PhysioLife Clinic" },
...
function AboutPage() {
  return (
    <>
      <PageHeader eyebrow="About" title="Hi, I'm Dr. [Sister Name]" subtitle="A physiotherapist devoted to helping you move better, recover faster and live without limits." />

      <Section>
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-16">
          <div className="relative">
            <div className="absolute -right-4 -top-4 h-32 w-32 rounded-full bg-primary/20 blur-2xl" />
            <img src={aboutImg} alt="Dr. [Sister Name] portrait" width={1024} height={1280} loading="lazy" className="relative rounded-3xl object-cover shadow-soft" />
          </div>
          <div>
            <h2 className="font-display text-3xl font-semibold">My approach</h2>
            <div className="mt-5 space-y-4 text-muted-foreground">
              <p>I founded PhysioLife Clinic to offer something patients told me they couldn't easily find: unhurried sessions, real listening, and a clinician who treats the cause, not just the symptom.</p>
              <p>Whether you're recovering from surgery, managing chronic pain, or returning to sport, we'll design a program that fits your body, your schedule and your goals.</p>
            </div>

            <h3 className="mt-10 font-display text-xl font-semibold">Qualifications</h3>
      ...
      <section className="bg-secondary/40">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
          <div className="text-center">
            <span className="text-xs font-semibold uppercase tracking-widest text-primary">Why choose me</span>
            <h2 className="mt-2 font-display text-3xl font-semibold sm:text-4xl">Care that goes further</h2>
          </div>
          ...
          <div className="mt-12 text-center">
            <Link to="/appointment" className="inline-flex items-center rounded-full bg-primary px-7 py-3.5 text-sm font-semibold text-primary-foreground shadow-soft hover:scale-[1.03] transition-transform">
